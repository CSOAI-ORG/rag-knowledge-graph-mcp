<!-- mcp-name: CSOAI-ORG/rag-knowledge-graph-mcp -->
[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/rag-knowledge-graph-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/rag_knowledge_graph_mcp/)

> RAG + Knowledge Graph MCP — hybrid retrieval with vector embeddings + graph traversal
...
```bash
# Install via pip
pip install rag_knowledge_graph_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install rag-knowledge-graph-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/rag-knowledge-graph-mcp)
